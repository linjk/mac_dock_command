...
Task 4 已完成：ANSI 剥离与 10_000 行环形日志缓冲可单测。下一步 Task 5。
...
- 2026-09-05：`xcodebuild -project BarCmd/BarCmd.xcodeproj -scheme BarCmd -destination 'platform=macOS' test` → `** TEST SUCCEEDED **`（Executed 17 tests, 0 failures）
